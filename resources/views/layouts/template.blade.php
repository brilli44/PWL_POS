...
<head>
    ...
    <title>{{ config('app.name', 'PWL Laravel Strater Code') }}</title>
      ...
      <!-- Jobsheet 7 praktikum 3 baagian 6 -->
...
<body class="hold-transition sidebar-mini">
    ...
    <script src="{{ asset('adminlte/plugins/datatables-buttons/js/dataTables.buttons.min.js') }}"></script> <script src="{{ asset('adminlte/plugins/datatables-buttons/js/buttons.bootstrap4.min.js') }}"></script>
